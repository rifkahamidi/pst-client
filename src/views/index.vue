...
import LandingBuyTradeImage from '@/components/LandingBuyTradeImage.vue'
import LandingExchange from '@/components/LandingExchange.vue'
import LandingPartnerImage from '@/components/LandingPartnerImage.vue'
  ...
  <div class="w-full">
    ...
    <section id="hero" class="w-full pb-24">
      <BaseSection>
        ...
        /> -->
        <img :src="ellipse-1" alt="Ellipse-1" />
        <!-- <img
          data-aos="fade-up"
          data-aos-delay="300"
        ...
        /> -->
        <img :src="ellipse-2" alt="Ellipse-2" />
        <!-- <img
          data-aos="fade-up"
          data-aos-delay="300"
        ...
        /> -->
        <img :src="ellipse-3" alt="Ellipse-3" />
        <!-- <img
          data-aos="fade-up"
          data-aos-delay="300"
