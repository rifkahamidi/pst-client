...
const layananList = ref([
  ...
  },
  {
    ...
    title: 'Lainnya',
    category: 'Layanan Instansi',
    description: 'Layanan bagi umum seperti pengantaran surat atau bertemu dengan pegawai tidak dalam keperluan layanan statistik.',
    actionText: 'Lainnya',
    badgeText: 'GRATIS',
    icon: 'briefcase',
    iconBgColor: 'bg-[#D97706]',
      ...
      >
        ...
        <div>
          ...
          <div :class="['w-16 h-16 rounded-full flex items-center justify-center text-white mb-6 shadow-sm', layanan.iconBgColor]">
            ...
            <svg v-if="layanan.icon === 'briefcase'" class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
          </div>
